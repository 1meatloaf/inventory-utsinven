package com.utsinven.inventoryms_springboot_api.services;

import com.utsinven.inventoryms_springboot_api.models.Item;
import com.utsinven.inventoryms_springboot_api.models.Order;
import com.utsinven.inventoryms_springboot_api.models.OrderStats;
import com.utsinven.inventoryms_springboot_api.repositories.ItemRepository;
import com.utsinven.inventoryms_springboot_api.repositories.OrderRepository;
    ...
    public Order save(Order order) {
        ...
        order.getOrderItems().forEach(orderItem -> {
            ...
            if(newQuantity < item.getReorder_level()) {
                throw new IllegalArgumentException(String.format("Quantity of the item %s is not available. Please reduce %s or less",
